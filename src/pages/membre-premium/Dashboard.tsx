  ...
  return (
    <MembrePremiumLayout>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
        <Link to="/espace-membre-premium/inscriptions" className="bg-card border rounded-2xl p-5 hover:shadow-md transition-shadow">
        ...
        <Link to="/espace-membre-premium/ateliers" className="bg-card border rounded-2xl p-5 hover:shadow-md transition-shadow">
          <div className="flex items-center gap-3 mb-2">
        ...
        <Link to="/espace-membre-premium/inscriptions?tab=passees" className="bg-card border rounded-2xl p-5 hover:shadow-md transition-shadow">
          <div className="flex items-center gap-3 mb-2">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 bg-card border rounded-2xl p-5">
          <div className="flex items-center justify-between mb-4">
            ...
            <Link to="/espace-membre-premium/inscriptions" className="text-xs text-primary hover:underline flex items-center gap-1">
          ...
          {upcomingMine.length === 0 ? (
            <div className="text-center py-8">
              ...
              <Link
                to="/espace-membre-premium/ateliers"
        ...
        <div className="bg-card border rounded-2xl p-5">
          <div className="flex items-center justify-between mb-4">
            ...
            <Link to="/espace-membre-premium/magazine" className="text-xs text-primary hover:underline flex items-center gap-1">
              Tous <ArrowRight className="w-3 h-3" />
            </Link>
          </div>

          {latestMagazine ? (
            <Link to="/espace-membre-premium/magazine" className="block group">
