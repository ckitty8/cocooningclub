...
COMMENT ON COLUMN utilisateurs.couleur_conge IS
  'Clé de couleur (teal, emerald, green, cyan, sky, blue, indigo, violet, fuchsia, pink) affichée sur le calendrier pour les congés de cet admin. NULL = non choisie.';
...
-- 3. Ajouter les couleurs valides via CHECK (optionnel mais robuste)
ALTER TABLE utilisateurs
...
ALTER TABLE utilisateurs
  ...
  CHECK (
    ...
    OR couleur_conge IN ('teal', 'emerald', 'green', 'cyan', 'sky', 'blue', 'indigo', 'violet', 'fuchsia', 'pink')
  );
